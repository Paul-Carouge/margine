...
class $ProductsTable extends Products with TableInfo<$ProductsTable, Product> {
  ...
  static const VerificationMeta _listingPriceMeta = const VerificationMeta(
    'listingPrice',
  );
  @override
  late final GeneratedColumn<double> listingPrice = GeneratedColumn<double>(
    'listing_price',
    aliasedName,
    true,
    type: DriftSqlType.double,
  ...
  static const VerificationMeta _vintedFeesMeta = const VerificationMeta(
    'vintedFees',
  );
  @override
  late final GeneratedColumn<double> vintedFees = GeneratedColumn<double>(
    'vinted_fees',
    aliasedName,
    false,
    type: DriftSqlType.double,
  ...
  VerificationContext validateIntegrity(
    ...
    if (data.containsKey('listing_price')) {
      context.handle(
        _listingPriceMeta,
        listingPrice.isAcceptableOrUnknown(
          data['listing_price']!,
          _listingPriceMeta,
        ),
      );
    ...
    if (data.containsKey('vinted_fees')) {
      context.handle(
        _vintedFeesMeta,
        vintedFees.isAcceptableOrUnknown(data['vinted_fees']!, _vintedFeesMeta),
      );
    }
  ...
  Product map(Map<String, dynamic> data, {String? tablePrefix}) {
    ...
    return Product(
      ...
      listingPrice: attachedDatabase.typeMapping.read(
        DriftSqlType.double,
        data['${effectivePrefix}listing_price'],
      ),
      ...
      vintedFees: attachedDatabase.typeMapping.read(
        DriftSqlType.double,
        data['${effectivePrefix}vinted_fees'],
      )!,
...
class ProductsCompanion extends UpdateCompanion<Product> {
  ...
  final Value<double?> listingPrice;
  final Value<double?> minPrice;
  final Value<double?> salePrice;
  final Value<DateTime?> saleDate;
  final Value<double> vintedFees;
  ...
  const ProductsCompanion({
    ...
    this.listingPrice = const Value.absent(),
    this.minPrice = const Value.absent(),
    this.salePrice = const Value.absent(),
    this.saleDate = const Value.absent(),
    this.vintedFees = const Value.absent(),
  ...
  static Insertable<Product> custom({
    ...
    Expression<double>? listingPrice,
    Expression<double>? minPrice,
    Expression<double>? salePrice,
    Expression<DateTime>? saleDate,
    Expression<double>? vintedFees,
    ...
    return RawValuesInsertable({
      ...
      if (vintedFees != null) 'vinted_fees': vintedFees,
  ...
  ProductsCompanion copyWith({
    ...
    return ProductsCompanion(
      ...
      vintedFees: vintedFees ?? this.vintedFees,
  ...
  Map<String, Expression> toColumns(bool nullToAbsent) {
    ...
    if (listingPrice.present) {
      map['listing_price'] = Variable<double>(listingPrice.value);
    }
    if (minPrice.present) {
    ...
    if (vintedFees.present) {
      map['vinted_fees'] = Variable<double>(vintedFees.value);
    }
  ...
  String toString() {
    return (StringBuffer('ProductsCompanion(')
          ...
          ..write('source: $source, ')
          ..write('status: $status, ')
          ..write('listingPrice: $listingPrice, ')
          ..write('minPrice: $minPrice, ')
          ..write('salePrice: $salePrice, ')
          ..write('saleDate: $saleDate, ')
          ..write('vintedFees: $vintedFees, ')
...
abstract class _$AppDatabase extends GeneratedDatabase {
  ...
  late final Index idxProductsStatus = Index(
    'idx_products_status',
...
class $$ProductsTableFilterComposer
  ...
  ColumnFilters<double> get listingPrice => $composableBuilder(
    column: $table.listingPrice,
    builder: (column) => ColumnFilters(column),
  );
  ...
  ColumnFilters<double> get vintedFees => $composableBuilder(
    column: $table.vintedFees,
    builder: (column) => ColumnFilters(column),
  );
...
class $$ProductsTableOrderingComposer
  ...
  ColumnOrderings<double> get listingPrice => $composableBuilder(
    column: $table.listingPrice,
    builder: (column) => ColumnOrderings(column),
  );
  ...
  ColumnOrderings<double> get vintedFees => $composableBuilder(
    column: $table.vintedFees,
    builder: (column) => ColumnOrderings(column),
  );
...
class $$ProductsTableAnnotationComposer
  ...
  GeneratedColumn<double> get listingPrice => $composableBuilder(
    column: $table.listingPrice,
    builder: (column) => column,
  );
  ...
  GeneratedColumn<double> get vintedFees => $composableBuilder(
    column: $table.vintedFees,
    builder: (column) => column,
  );
        ...
        TableManagerState(
          ...
          updateCompanionCallback:
              ({
                ...
                Value<double?> listingPrice = const Value.absent(),
                Value<double?> minPrice = const Value.absent(),
                Value<double?> salePrice = const Value.absent(),
                Value<DateTime?> saleDate = const Value.absent(),
                Value<double> vintedFees = const Value.absent(),
